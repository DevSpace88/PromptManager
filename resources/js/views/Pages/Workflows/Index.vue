...
<!--  router.post(route('workflows.execute', workflowToExecute.value.id), {-->
...
<!--onMounted(() => {-->
<!--  deleteModal.value = new bootstrap.Modal(document.getElementById('modal-delete-workflow'));-->
...
<!--  <BasePageHeading title="Workflows" subtitle="Build and automate your AI processes">-->
<!--    <template #extra>-->
<!--      <Link :href="route('workflows.create')" class="btn btn-alt-primary" v-click-ripple>-->
...
<!--              <Link :href="route('workflows.create')" class="btn btn-sm btn-alt-primary" v-click-ripple>-->
...
<!--          <div v-if="workflows.length === 0" class="block-content text-center py-6">-->
<!--            <div class="py-4">-->
<!--              <i class="fa fa-4x fa-diagram-project text-gray opacity-25 mb-3"></i>-->
<!--              <p class="fs-lg fw-medium text-gray-darker">You haven't created any workflows yet.</p>-->
<!--              <Link :href="route('workflows.create')" class="btn btn-hero btn-primary mt-2">-->
<!--                <i class="fa fa-plus opacity-50 me-1"></i> Create Your First Workflow-->
<!--              </Link>-->
<!--            </div>-->
<!--          </div>-->

<!--          &lt;!&ndash; Workflows Table &ndash;&gt;-->
...
<!--                  <td>-->
<!--                    <Link :href="route('workflows.show', workflow.id)" class="fw-semibold">-->
<!--                      {{ workflow.name }}-->
<!--                    </Link>-->
<!--                  </td>-->
...
<!--                        {{ workflow.last_execution_at ? formatDate(workflow.last_execution_at) : 'Never' }}-->
<!--                      </span>-->
<!--                  </td>-->
<!--                  <td class="text-center">-->
<!--                    <div class="btn-group">-->
...
<!--                      </button>-->
<!--                      <Link :href="route('workflows.show', workflow.id)" class="btn btn-sm btn-alt-secondary" title="View">-->
<!--                        <i class="fa fa-eye"></i>-->
<!--                      </Link>-->
<!--                      <Link :href="route('workflows.edit', workflow.id)" class="btn btn-sm btn-alt-secondary" title="Edit">-->
...
<!--    &lt;!&ndash; Workflow Export/Import Block &ndash;&gt;-->
<!--    <BaseBlock title="Import & Export">-->
<!--      <div class="row">-->
<!--        <div class="col-md-6">-->
<!--          <h4 class="h5 fw-medium">Export Workflow</h4>-->
<!--          <p class="text-muted fs-sm">Export your workflows to share with others or use as backups.</p>-->
<!--          <div v-if="workflows.length > 0" class="mb-4">-->
<!--            <div class="input-group">-->
<!--              <select class="form-select" id="workflow-export">-->
...
<!--                type="button"-->
<!--                @click="-->
<!--                  router.get(route('workflows.export', document.getElementById('workflow-export').value))-->
<!--                "-->
<!--                :disabled="!document.getElementById('workflow-export')?.value"-->
<!--              >-->
...
<!--          <form @submit.prevent="-->
<!--            router.post(route('workflows.import'), {-->
<!--              workflow_data: document.getElementById('workflow-import-data').value-->
<!--            })-->
<!--          ">-->
<!--            <div class="mb-4">-->
<!--              <textarea-->
<!--                id="workflow-import-data"-->
<!--                class="form-control"-->
<!--                rows="3"-->
...
<!--  <div class="modal fade" id="modal-delete-workflow" tabindex="-1" role="dialog" aria-labelledby="modal-delete-workflow" aria-hidden="true">-->
...
<!--            <p v-if="workflowToDelete" class="fw-semibold">{{ workflowToDelete.name }}</p>-->
<!--            <p class="text-danger">-->
<!--              <i class="fa fa-exclamation-triangle me-1"></i> This action cannot be undone. The workflow and all its execution history will be permanently deleted.-->
<!--            </p>-->
<!--          </div>-->
...
<!--    </div>-->
<!--  </div>-->
<!--  &lt;!&ndash; END Delete Confirmation Modal &ndash;&gt;-->

<!--  &lt;!&ndash; Execute Workflow Modal &ndash;&gt;-->
...
<!--          </div>-->
<!--          <div class="block-content fs-sm">-->
<!--            <p v-if="workflowToExecute" class="fw-semibold">{{ workflowToExecute.name }}</p>-->

<!--            &lt;!&ndash; Input Variables &ndash;&gt;-->
...
<!--    </div>-->
<!--  </div>-->
<!--  &lt;!&ndash; END Execute Workflow Modal &ndash;&gt;-->
<!--</template>-->
...
const exportWorkflow = () => {
  ...
  router.get(route('workflows.export', selectedWorkflowId.value));
};
...
const importWorkflow = () => {
  ...
  router.post(route('workflows.import'), {
    workflow_data: importData.value
  });
};
