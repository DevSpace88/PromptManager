<!--&lt;!&ndash; resources/js/views/Pages/Workflows/Components/WorkflowEditor.vue &ndash;&gt;-->
<!--<script setup>-->
...
<!--      &lt;!&ndash; Node Sidebar - Only show if not readOnly &ndash;&gt;-->
