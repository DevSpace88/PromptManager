      ...
      <div class="content content-full">
        <div class="row g-0 justify-content-center text-center">
          <div class="col-md-10 pt-7 pb-9">
            ...
            >
              <span>🔥</span>
              <span>Laravel 12 + Inertia.js + Auth version is here!</span>
            </div>
            <h1 class="h1 fw-black mb-3">
              Building super modern web applications made simple
            </h1>
            <p class="fs-5 fw-medium text-muted mb-4 mx-xl-8">
              One super flexible UI framework for web developers and founders
              who value their time. Built with
              <span class="text-body-color fw-semibold">Bootstrap 5</span>,
              <span class="text-body-color fw-semibold">no jQuery</span> in
              core, now with a brand new
              <a
                href="#"
                @click.prevent="
                  () => {
                    if (store.settings.darkModeActive) {
            ...
            <a
              class="btn btn-alt-secondary py-2 px-3 m-1"
      ...
      <div class="content content-full">
        ...
        <div class="row py-5">
          ...
          <div class="col-6 col-md-3">
            ...
            <p class="text-muted">
              A brand new version with Inertia.js and Auth is now included.
            </p>
          </div>
          <div class="col-6 col-md-3">
      ...
      <div class="content content-full">
          ...
          <div class="row mb-5">
            <div class="col-md-6">
              ...
              <p class="fs-lg fw-medium text-muted mb-0">
                ...
                Laravel + Inertia.js based one, we've got you covered.
              </p>
            </div>
            <div
        ...
        <div class="row g-4 g-sm-5">
          <div class="col-sm-6">
            ...
            <h3 class="h5 mb-3">Vue.js 3 version</h3>
            <ul class="fa-ul space-y-2 text-muted push">
              <li>
          ...
          <div class="col-sm-6">
            ...
            <h3 class="h5 mb-3">Laravel 12 + Inertia.js + Vue.js 3 version</h3>
            <ul class="fa-ul space-y-2 text-muted push">
              <li>
                <span class="fa-li text-start">
                  <i class="fa fa-check-circle text-success"></i>
                </span>
                Includes all demo pages and components from the Vue.js 3
                version.
              </li>
              <li>
                <span class="fa-li text-start">
                ...
                Includes Authentication features (similar to Laravel Breeze) out
                of the box (Login, Register, Reset Password, Email Verification,
                Secure Areas with Password Confirmation, Profile Edit page).
              </li>
            </ul>
          </div>
        </div>
    ...
    <div id="one-vue-trusted-by" class="bg-body-light">
      <div class="content py-6">
        ...
        <div class="row items-push text-center py-4">
          ...
          <div class="col-sm-4">
            <div class="h1 fw-extrabold mb-1">35+</div>
